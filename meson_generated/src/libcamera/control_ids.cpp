...
/**
 * \var ControlListSequence
 * \brief This is the sequence number of the request whose control list has
...
extern const Control<int64_t> ControlListSequence(CONTROL_LIST_SEQUENCE, "ControlListSequence", "rpi", ControlId::Direction::Out);
...
extern const ControlIdMap controls {
	...
	{ rpi::CONTROL_LIST_SEQUENCE, &rpi::ControlListSequence },
