...
$(M_TARGET_PREFIX)LIBCAMERA_IPA_RPI_PISP_BIN := $(MESON_OUT_DIR)/install/usr/local/lib/libcamera/ipa/ipa_rpi_pisp.so
$(M_TARGET_PREFIX)LIBCAMERA_IPA_RPI_PISP_SIGN := $(MESON_OUT_DIR)/install/usr/local/lib/libcamera/ipa/ipa_rpi_pisp.so.sign
$(M_TARGET_PREFIX)LIBCAMERA_IPA_RPI_VC4_BIN := $(MESON_OUT_DIR)/install/usr/local/lib/libcamera/ipa/ipa_rpi_vc4.so
$(M_TARGET_PREFIX)LIBCAMERA_IPA_RPI_VC4_SIGN := $(MESON_OUT_DIR)/install/usr/local/lib/libcamera/ipa/ipa_rpi_vc4.so.sign
