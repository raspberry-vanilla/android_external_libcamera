...
$(M_TARGET_PREFIX)LIBCAMERA_IPA_RPI_BIN := $(MESON_OUT_DIR)/install/usr/local/lib/libcamera/ipa_rpi.so
$(M_TARGET_PREFIX)LIBCAMERA_IPA_RPI_SIGN := $(MESON_OUT_DIR)/install/usr/local/lib/libcamera/ipa_rpi.so.sign
